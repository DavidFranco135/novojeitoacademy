...
const DEFAULT_CONTENT = {
  ...
  faq: [
    ...
    { pergunta: "Quais formas de pagamento vocês aceitam?", resposta: "Pix, dinheiro ou cartão à vista, cartão parcelado em até 10x sem juros, ou boleto parcelado em até 3x (só no plano sem kit) — tudo via Mercado Pago." },
  ],
