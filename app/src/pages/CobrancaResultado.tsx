...
/**
 * Tela de retorno após o checkout de uma cobrança avulsa (link gerado pelo admin
 * fora do fluxo de matrícula — ex: adiantamento pra quem ainda não se cadastrou).
 * Rotas: /cobranca/sucesso, /cobranca/erro, /cobranca/pendente
 */
...
const CONTENT: Record<string, { icon: string; title: string; text: string }> = {
  sucesso: {
    ...
    text: "Seu pagamento foi aprovado. Nossa equipe já foi avisada e vai entrar em contato pelo WhatsApp para os próximos passos.",
  },
  erro: {
    icon: "✕",
    title: "Pagamento não aprovado",
    text: "Não conseguimos confirmar o pagamento. Você pode tentar novamente ou falar com a gente pelo WhatsApp.",
  },
  pendente: {
    icon: "⏳",
    title: "Pagamento em análise",
    text: "Recebemos seu pagamento e ele está sendo processado (comum em boleto e alguns cartões). Assim que for aprovado, avisamos você.",
  },
};

export default function CobrancaResultado() {
